...
describe('Languages', () => {
    ...
    <body onload="notificationPermission()">
        ...
        <div id="howTo" style="display: none;">
            ...
            <div id="howToText">
                <ol id="howToList">
                    <li id="howToItemsLine1" class="howToItems">Add tasks to work on for the day in the "Upcoming Tasks."</li>
                    <li id="howToItemsLine2" class="howToItems">Set the estimated that it will take to finish for each task (one defaulted pomo = 25 minutes of work).</li>
                    <li id="howToItemsLine3" class="howToItems">You are able to change the priority in task lists using the arrow buttons.</li>
                    <li id="howToItemsLine4" class="howToItems">Current task will be the top priority task.</li>
                    <li id="howToItemsLine5" class="howToItems">Start the timer and work on your current task until time is up.</li>
                    <li id="howToItemsLine6" class="howToItems">Finished pomos will be keep track and record in "Work Periods Completed."</li>
                    <li id="howToItemsLine7" class="howToItems">If you finish your task, press "Done" button on your "Current Task."</li>
                    <li id="howToItemsLine8" class="howToItems">If you need more time to finish your task, press "+" to add more pomos in "Estimated Pomos."</li>
                    <li id="howToItemsLine9" class="howToItems">Automatically take a short break (5 minutes) when the first work period is done or if you finish a task. You deserve it!</li>
                    <li id="howToItemsLine10" class="howToItems">The timer will repeat these steps 3 times then will automatically start a long break (15 minutes).</li>
                    <li id="howToItemsLine11" class="howToItems">The timer will repeat this process until all tasks are completed.</li>
                    <li id="howToItemsLine12" class="howToItems">If you want to stop to work on the task, click "Stop". The whole work period will be reset.</li>
                    <li id="howToItemsLine13" class="howToItems">Reward yourself for working so hard!</li>
                </ol>
            </div>
        </div> 
