...
function setLanguage(language) {
  ...
  if (language === 'en') {
    ...
    document.getElementById('aboutTestDescription').textContent =
      'La Técnica Pomodoro proporcionará una herramienta / proceso simple para mejorar la productividad (la suya y la de los miembros de su equipo) que puede hacer lo siguiente';
    document.getElementById('aboutItemsLine1').textContent =
      'Aliviar la ansiedad vinculada al comienzo';
    document.getElementById('aboutItemsLine2').textContent =
      'Mejore el enfoque y la concentración reduciendo las interrupciones';
    document.getElementById('aboutItemsLine3').textContent =
      'Aumente el conocimiento de sus decisiones';
    document.getElementById('aboutItemsLine4').textContent =
      'Aumenta la motivación y mantenla constante';
    document.getElementById('aboutItemsLine5').textContent =
      'Refuerce la determinación para lograr sus objetivos';
    document.getElementById('aboutItemsLine6').textContent =
      'Perfeccionar el proceso de estimación, tanto en términos cualitativos como cuantitativos';
    document.getElementById('aboutItemsLine7').textContent =
      'Mejora tu proceso de trabajo o estudio';
    document.getElementById('aboutItemsLine8').textContent =
      'Fortalece tu determinación de seguir aplicándote frente a situaciones complejas';

    document.getElementById('howToTitle').textContent = 'Cómo usar Barbz Timer';
    document.getElementById('howToItemsLine1').textContent =
      'Agregue tareas en las que trabajar durante el día en "Próximas tareas".';
    document.getElementById('howToItemsLine2').textContent =
      'Establezca el estimado que tomará terminar para cada tarea (un pomo predeterminado = 25 minutos de trabajo).';
    document.getElementById('howToItemsLine3').textContent =
      'Puede cambiar la prioridad en las listas de tareas utilizando los botones de flecha.';
    document.getElementById('howToItemsLine4').textContent =
      'La tarea actual será la tarea de máxima prioridad.';
    document.getElementById('howToItemsLine5').textContent =
      'Inicie el temporizador y trabaje en su tarea actual hasta que se acabe el tiempo.';
    document.getElementById('howToItemsLine6').textContent =
      'Los pomos terminados se realizarán un seguimiento y se registrarán en "Períodos de trabajo completados".';
    document.getElementById('howToItemsLine7').textContent =
      'Si finaliza su tarea, presione el botón "Listo" en su "Tarea actual".';
    document.getElementById('howToItemsLine8').textContent =
      'Si necesita más tiempo para terminar su tarea, presione "+" para agregar más pomos en "Pomos estimados".';
    document.getElementById('howToItemsLine9').textContent =
      'Tómese automáticamente un breve descanso (5 minutos) cuando termine el primer período de trabajo o si termina una tarea. ¡Te lo mereces!';
    document.getElementById('howToItemsLine10').textContent =
      'El temporizador repetirá estos pasos 3 veces y luego iniciará automáticamente una pausa larga (15 minutos).';
    document.getElementById('howToItemsLine11').textContent =
      'El temporizador repetirá este proceso hasta que se completen todas las tareas.';
    document.getElementById('howToItemsLine12').textContent =
      'Si desea dejar de trabajar en la tarea, haga clic en "Detener". Se reiniciará todo el período de trabajo.';
    document.getElementById('howToItemsLine13').textContent =
      '¡Recompénsese por trabajar tan duro!';
    ...
    document.getElementById('workPeriodsHeader').textContent =
      'Períodos de Trabajo Completados';
    ...
    document.getElementById('aboutTestDescription').textContent =
      '番茄技術將提供一個簡單的工具/流程來提高生產力（您自己和您的團隊成員的生產力），可以執行以下操作：';
    document.getElementById('aboutItemsLine1').textContent =
      '減輕與開始有關的焦慮';
    document.getElementById('aboutItemsLine2').textContent =
      '通過減少打擾來增強注意力和專注力';
    ...
    document.getElementById('howToItemsLine1').textContent =
      '在接下來的任務中添加當天要處理的任務。';
    document.getElementById('howToItemsLine2').textContent =
      '設置完成每個任務所需的估計時間（一個默認的pomo = 25分鐘的工作時間）。';
    document.getElementById('howToItemsLine3').textContent =
      '您可以使用箭頭按鈕更改任務列表中的優先級';
    document.getElementById('howToItemsLine4').textContent =
      '當前任務將是最優先的任務。';
    document.getElementById('howToItemsLine5').textContent =
      '啟動計時器並處理您當前的任務，直到時間到了。';
    document.getElementById('howToItemsLine6').textContent =
      '完成的pomos將在工作期間跟踪和記錄。';
    document.getElementById('howToItemsLine7').textContent =
      '如果完成任務，請在當前任務上按完成按鈕';
    document.getElementById('howToItemsLine8').textContent =
      '如果您需要更多時間來完成任務，請按加號以在估計的pomos中添加更多pomos。';
    document.getElementById('howToItemsLine9').textContent =
      '在完成第一個工作時間或完成任務後，系統會自動休息片刻（5分鐘）。你應得的！';
    document.getElementById('howToItemsLine10').textContent =
      '計時器將重複這些步驟3次，然後將自動開始長時間休息（15分鐘）。';
    document.getElementById('howToItemsLine11').textContent =
      '計時器將重複此過程，直到完成所有任務。';
    document.getElementById('howToItemsLine12').textContent =
      '如果要停止執行該任務，請單擊“停止”。整個工作週期將被重置。';
    document.getElementById('howToItemsLine13').textContent =
      '獎勵自己這麼努力！';
