...
/**
 * Allow's users to select the type of language that the user
 * is most comfortable reading and using.
 * 
 * @param {language} language The type of language the user selects for the webpage to be in.
 */
function setLanguage(language) {
  ...
  if (language === 'en') {
    ...
    if (
      ...
      muteButtonText[localStorage.getItem('language')]
    ) {
      document.getElementById('mute-notifications').textContent =
        'Mute Notifications';
    } else {
